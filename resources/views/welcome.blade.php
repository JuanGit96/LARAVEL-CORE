...
<div class="container-fluid p-0">
    ...
    <div class="my-auto">
        <h1 class="mb-0">Juan Daniel
        <span class="text-primary">Cárdenas Davila</span>
        </h1>
        <div class="subheading mb-5">Bogotá Colombia · (319) 217-5910 ·
        <a href="mailto:jdcardenasd10@gmail.com" style="text-transform: capitalize;">jdcardenasd10@gmail.com</a>
        </div>
    ...
    <div class="my-auto">
        <h2 class="mb-5">Premios &amp; Certificaciones</h2>
        <ul class="fa-ul mb-0">
        <li>
